...
const (
	UserService_SignUp_FullMethodName = "/memo.v1.UserService/SignUp"
	UserService_SignIn_FullMethodName = "/memo.v1.UserService/SignIn"
)
...
//
// UserService は、ユーザーの登録（SignUp）と認証（SignIn）を行うサービスです。
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "memo.v1.UserService",
