...
const (
	GreetService_Greet_FullMethodName = "/memo.v1.GreetService/Greet"
)
...
//
// GreetService は、指定された名前に対して挨拶を返すサービスです。
...
// UnimplementedGreetServiceServer should be embedded to have
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "memo.v1.GreetService",
